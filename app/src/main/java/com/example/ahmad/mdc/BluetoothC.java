...
public class BluetoothC extends Activity {

    private static final String TAG = "BlueTest5-BluetoothC";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bluetoothc);
    ...
    private class ConnectBT extends AsyncTask<Void, Void, Void> {
        ...
        @Override
        protected void onPreExecute() {
            progressDialog = ProgressDialog.show(BluetoothC.this, "Hold on", "Connecting");// http://stackoverflow.com/a/11130220/1287554
        }
